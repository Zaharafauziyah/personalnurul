...
<h2 class="text-xl font-bold text-red-800">Tentang Saya</h2>
<a href="add_about.php"
class="bg-red-600 text-red px-4 py-2 rounded hover:bg-red-700 transition">+ Tambah Data</a>
</div>
<div class="space-y-4">
<?php
...
echo "<div class='p-4 bg-red-50 border rounded shadow'>";
echo "<p class='mb-3'>" . htmlspecialchars($data['about']) . "</p>";
echo "<div class='flex space-x-4 text-sm'>";
echo "<a href='edit_about.php?id_about={$data['id_about']}' class='text-red-600 hover:underline'>Edit</a>";
