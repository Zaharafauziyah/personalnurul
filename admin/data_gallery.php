...
<div class="flex max-w-7xl mx-auto mt-8 px-4">
    ...
    <main class="w-3/4 bg-red rounded shadow p-6 ml-6">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-red-800">Daftar Gallery</h2>
            <a href="add_gallery.php"
               class="bg-red-600 text-red px-4 py-2 rounded hover:bg-red-700 transition">+ Tambah Gambar</a>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            while ($data = mysqli_fetch_array($query)) {
                echo "<div class='bg-red-50 border rounded shadow overflow-hidden'>";
                echo "<img src='../images/{$data['foto']}' class='w-full h-48 object-cover'>";
                echo "<div class='p-4'>";
                echo "<p class='font-semibold text-red-800 mb-2'>" . htmlspecialchars($data['judul']) . "</p>";
                echo "<div class='flex justify-between text-sm'>";
                echo "<a href='edit_gallery.php?id_gallery={$data['id_gallery']}' class='text-red-600 hover:underline'>Edit</a>";
...
<!-- Footer -->
<footer class="bg-red-800 text-red text-center py-4 mt-10">
