...
<!-- Header -->
<header class="bg-red-900 text-red text-center py-6 shadow">
...
<div class="text-lg text-red-800 mb-4">
Halo, Saya <strong class="text-red-700"><?php echo $_SESSION['username']; ?></strong>! Apa kabar? 😊
</div>
<p class="text-sm text-red-500">Silakan gunakan menu di samping untuk mengelola data.</p>
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
<div class="bg-white shadow rounded p-4 text-center border-t-4 border-red-600">
<h3 class="text-xl font-semibold text-red-700">Artikel</h3>
<p class="text-3xl font-bold text-red-800"><?php echo $jumlah_artikel; ?></p>
</div>
<div class="bg-white shadow rounded p-4 text-center border-t-4 border-red-600">
<h3 class="text-xl font-semibold text-red-700">Gallery</h3>
<p class="text-3xl font-bold text-red-800"><?php echo $jumlah_gallery; ?></p>
</div>
</div>
</main>
</div>
...
&copy; <?php echo date('Y'); ?> | Created by NurulPauziah
</footer>
</body>
</html>