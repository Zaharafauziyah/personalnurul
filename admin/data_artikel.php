...
<h2 class="text-xl font-bold text-red-800">Daftar Artikel</h2>
<a href="add_artikel.php"
class="bg-red-600 text-red px-4 py-2 rounded hover:bg-red-700 transition">+ Tambah Artikel</a>
</div>
<table class="min-w-full table-auto border border-red-300 text-sm">
<thead class="bg-red-600 text-red">
<tr>
...
<a href='edit_artikel.php?id_artikel={$data['id_artikel']}' class='text-red-600 hover:underline'>Edit</a>
