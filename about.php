...
<body class="bg-red-100 text-gray-800 font-sans">
<!-- Header -->
<header class="bg-red-900 text-red text-center p-6 text-2xl font-bold">
About Me | NurulPauziah
</header>
<!-- Navigation -->
<nav class="bg-red-700 text-red py-3">
